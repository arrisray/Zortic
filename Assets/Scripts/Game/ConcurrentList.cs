...
/// </summary>
public class ConcurrentEnumerable<T> : IEnumerable<T>
{
    private readonly IEnumerable<T> _inner;
    private readonly object _lock;
 
    public ConcurrentEnumerable(IEnumerable<T> inner, object @lock)
    {
        _lock = @lock;
        _inner = inner;
    }
    ...
    {
        return new ConcurrentEnumerator<T>(_inner.GetEnumerator(), _lock);
    }
...
public class ConcurrentEnumerator<T>: IEnumerator<T>
{
    ...
    public ConcurrentEnumerator(IEnumerator<T> inner, object @lock)
    {
        _inner = inner;
        _lock = @lock;
...
/// <summary>
/// A thread-safe IList implementation using the custom ConcurrentEnumerator class
/// See: http://www.codeproject.com/KB/cs/safe_enumerable.aspx
/// </summary>
